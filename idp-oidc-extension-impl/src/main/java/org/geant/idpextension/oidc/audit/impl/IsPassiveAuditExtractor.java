...
public class IsPassiveAuditExtractor implements Function<ProfileRequestContext, Boolean> {
     ...
     */
    public IsPassiveAuditExtractor(@Nonnull final Function<ProfileRequestContext, AuthenticationRequest> strategy) {
    ...
    public Boolean apply(@Nullable final ProfileRequestContext input) {
        ...
        if (request != null && request.getPrompt() != null) {
            return request.getPrompt().contains(Prompt.Type.NONE);
        }
